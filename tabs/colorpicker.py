...
class ColorPicker(QWidget):
  ...
  def GetColor(self):
    ...
    self.rgbEdit.setText(str.format("rgb(%s, %s, %s)" % (color.red(), color.green(), color.blue())))
    self.sampleTextLight.setStyleSheet("padding: 10px; background-color: white; color: %s" % color.name())
    self.sampleTextDark.setStyleSheet("padding: 10px; background-color: black; color: %s" % color.name())